...
<!--Page -->
<form id="pagerForm" data-toggle="ajaxsearch" action="{:U('Order/Index/pre_sales',array('menuid'=>$menuid));}" method="post">
  ...
  <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
    ...
    <volist name="data" id="vo">
      <tr data-id="{$vo.order_sn}" data-num="{$vo.number}" data-money="{$vo.money}">
        ...
        {$vo['type']|print_buttn_show=$vo['pay'],$vo['order_sn'],$vo['plan_id'],$vo['money'],1,$vo['activity']}
        </td>
       </tr>
    </volist>
     <tr>
     ...
     <td id="sub-pre-money" align="right">0.00</td>
