...
<!--Page -->
<form id="pagerForm" data-toggle="ajaxsearch" action="{:U('Order/Index/team',array('menuid'=>$menuid));}" method="post">
  ...
  <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
    ...
    <volist name="data" id="vo">
      <tr data-id="{$vo.order_sn}" data-num="{$vo.number}" data-money="{$vo.money}">
        ...
        <td align="center"><a data-toggle="dialog" href="{:U('Order/Index/team_report',array('sn'=>$vo['order_sn']))}" data-id="team_report" data-width="900" data-height="600" data-title="团队接待单">接待单</a>
        </td>
       </tr>
    </volist>
     <tr>
