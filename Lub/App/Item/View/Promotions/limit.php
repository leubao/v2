...
<div class="bjui-pageContent">
    <div class="panel panel-default">
      <div class="panel-body">
        当前售票:{$product.name} {$plan.id|planShow}<a style="float: right;margin-right: 30px" href="#" onclick="$(this).dialog('refresh');" data-placement="top" data-toggle="tooltip" rel="reload" title="刷新当前页"><i class="fa fa-refresh"></i></a>
      </div>
    </div>
    <div style="float:left; width:200px;height:93.5%;" class="border">
        <ul id="quick-tree" class="ztree" data-toggle="ztree" data-expand-all="true" data-on-click="getprice">
            <li data-id="1" data-pid="0">座位区域</li>
            <volist name="param['seat']" id="vo">
            <li data-id="{$vo}" data-pid="1" data-type="{$type}" data-plan="{$plan.id}">{$vo|areaName}</li>
            </volist>
        </ul>
    </div>
