...
<div class="toolBar">
  <div class="btn-group" role="group"> 
    <a type="button" class="btn btn-success" href="{:U('Sales/Cashback/back',array('menuid'=>$menuid));}&id={#bjui-selected}" data-toggle="dialog" data-width="800" data-height="400" data-id="back550" data-mask="true"><i class="fa fa-legal"></i>  提现审核</a> 
    <a type="button" class="btn btn-info" href="{:U('Sales/Cashback/subsidies',array('id'=>$ginfo['id']));}}" data-toggle="dialog" data-width="800" data-height="400" data-id="subsidies553" data-mask="true"><i class="fa fa-cny"></i>  现金支付</a>
  </div>
  <!--帮助 说明--> 
...
<!--工具条 e--> 
<!--Page -->
<form id="pagerForm" data-toggle="ajaxsearch" action="{:U('Sales/Cashback/index',array('menuid'=>$menuid));}" method="post">
  ...
  <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
    <thead>
      <tr>
        ...
        <th align="center" width="90px">日期</th>
