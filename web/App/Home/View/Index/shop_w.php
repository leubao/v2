...
<div class="sui-container mt10">
  ...
  <div class="m-box m-box-col2 m-box-goods" id="projectInfo">
            ...
            <div class="m-product m-product-2-m-product-1 j_goodsDetails">
              ...
              <div class="m-choose m-choose-date  " data-col="4">
                ...
                <div class="ct">
                  ...
                  <volist name="plan" id="vo">
                    <li class=" <if condition="$i eq 1">itm-sel</if> itm j_more" data-plid="{$vo.id}" data-pltime="{$vo.title}" data-buycount="20"><a href="javascript:;">{$vo.title}</a></li>
                  </volist>
                  </ul>
                </div>
              </div>
              ...
              <div class="m-choose m-choose-price " data-col="4" data-performid="8764073">
                ...
                <div class="ct">
                  ...
                  <!--
                  <li class="itm   itm-oos" style="" data-pricename="学生票50" data-priceid="11222467" data-price="50" data-taopiao="false"><a href="javascript:;"><span class="price">学生票50</span><i></i></a></li>
                  <li class="itm   " style="" data-pricename="惠民票100" data-priceid="11222466" data-price="100" data-taopiao="false"><a href="javascript:;"><span class="price">惠民票100</span><i></i></a></li>-->
                  </ul>
          ...
          <div class="tips tips-oos" style="left: 90px; top: 346px;"><span class="ico"></span><span class="txt">暂时无货，登录试试运气~</span></div>
              ...
              <div class="m-cart  ">
                ...
                <div class="ct" style="">
                  ...
                  <!--
                  <li class="itm" data-performid="8744159" data-priceid="11176724"><span class="txt txt-datetime ">"2016-04-12 周二 19:30"</span><span class="txt txt-price">"普通票150"</span><span class="m-nums"><a class="btn btn-low" href="javascript:;">减</a><input class="ipt ipt-num" type="text" value="1"><a class="btn btn-add" href="javascript:;">加</a></span><span class="tips tips-stock"><strong></strong></span><a class="btn btn-del" href="javascript:;"><i></i>删除</a></li>-->
                  </ul>
                </div>
                ...
                <div class="ops">
                  ...
                  <!--
                  <a href="{:U('Home/Index/google')}" class="sui-btn btn-xlarge btn-orange" id="btnXuanzuo">选座购买</a>-->
                </div>
        ...
        <div class="sd">  
          ...
          <!--
            <a href="javascript:;" map-src="/map/map.html?zoom=14&amp;marker={y:39.9016772,x:116.3730896,text:''}" id="showVenueMap" class="u-btn u-btn-traffic"><i></i>交通路线</a>
                        </div>-->
            </div>
          </div>
          <!-- 演出场馆 end -->
...
$(document).ready(function($) {
  ...
  var plan = '0',
    ...
    function post_server(){
      ...
      /*获取支付相关数据*/
      postData = 'info={"plan_id":'+plan+',"data":['+ toJSONString + ']}';
      /*提交到服务器*/
      $.ajax({
          type:'POST',
