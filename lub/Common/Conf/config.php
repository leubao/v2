...
return array(
    ...
    'TMPL_ACTION_SUCCESS' => APP_PATH . 'Home/View/success.php', // 默认成功跳转对应的模板文件
    //'ERROR_PAGE' => 'http://www.leubao.com/cloud/error.html'
    //'TMPL_EXCEPTION_FILE' => APP_PATH . 'Manage/View/Common/Exception.php', // 异常页面的模板文件
    //'TMPL_TRACE_FILE' => APP_PATH . 'Manage/View/Common/Trace.php',
    ...
    'TAGLIB_BUILD_IN' => 'cx,Common\TagLib\LubLabel', // 内置标签库名称(标签使用不必指定标签库名称),以逗号分隔 注意解析顺序
    ...
    'URL_ROUTE_RULES' => array(
        't/:code'   => 'Api/Index/realBinding',
        'get_ticket/:qr'=> 'Api/Trust/getTicketInfo',
        'post_bind/:qr' => 'Api/Trust/realBinding',
    ), // 默认路由规则 针对模块
    'URL_MAP_RULES' => array(
