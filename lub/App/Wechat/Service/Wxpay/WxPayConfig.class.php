...
class WxPayConfig
{
    ...
    public function __construct($options){
        ...
        //服务商模式
        $this->sub_mchid = $options['sub_mchid'];
        $this->sub_appid = $options['sub_appid'];
        $this->sub_openid = $options['sub_openid'];
	 ...
	 * @var path
	 */
	const SSLCERT_PATH = 'd/pay/apiclient_cert.pem';
	const SSLKEY_PATH = 'd/pay/apiclient_key.pem';
