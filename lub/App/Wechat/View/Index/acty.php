      ...
      $.ajax({
        ...
        success:function(data){
            if(data.statusCode == "200"){
              ...
              param = '{"remark":"'+remark+'","id_card":"'+card+'","activity":"'+global['user']['activity']+'","settlement":"'+global['user']['epay']+'"}';
...
{{# $(d.area[laytpl.fn]).each(function(i){ }}
  <li class="tag sku-tag pull-left ellipsis {{# if(this.num == '0'){ }}unavailable{{# } }}" data-price="{{ this.money }}" data-discount="{{ this.moneys }}" data-area="{{ this.area }}" data-priceid="{{ this.priceid }}" data-num="{{ this.num }}">{{this.money}}元 ({{this.name}})</li>
{{#    });}}
</script>
