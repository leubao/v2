...
<Managetemplate file="Home/Public/css"/>
<header class="am-topbar am-topbar-inverse admin-header">
  <div class="am-topbar-brand">
    <strong>LubTMP</strong> <small>渠道分销管理</small>
  </div>
  ...
  <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list" id="user">
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      ...
      <div class="am-panel am-panel-default">
        <div class="am-panel-bd">当前用户：{$uinfo['cid']|itemnav} > {$uinfo['nickname']}<span style="float:right;">可用授信额: ￥<span id="cash"></span> </span></div>
      </div>
      <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
        <li><a href="#" class="am-text-success"><span class="am-icon-btn am-icon-rmb"></span><br/>可用授信额<br/>2300</a></li>
...
<a href="#" class="am-icon-btn am-icon-th-list am-show-sm-only admin-menu" data-am-offcanvas="{target: '#admin-offcanvas'}"></a>
 <Managetemplate file="Home/Public/js"/>
