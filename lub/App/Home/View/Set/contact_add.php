...
<div class="modal-body">
  <div class="panel panel-default cler_mag_20"> 
    ...
    <form action="{:U('Home/Set/contact_add');}" method="post">
      <div class="panel-body form-horizontal">
        <div class="form-group">
          <label class="col-sm-2 control-label">姓名</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" name="name" placeholder="如：姓名" required>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="id_card" placeholder="如：130123198809080000">
          </div>
        </div>
        <div class="form-group">
