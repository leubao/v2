    ...
    <div class="tabs" currentIndex="0" eventType="click">
        <div class="tabsHeader">
            <div class="tabsHeaderContent">
                <ul>
                    <li><a href="{:U('Crm/Reports/charts')}" class="j-ajax"><span>图表</span></a></li>
                    <li><a href="{:U('Crm/Reports/tables')}" class="j-ajax"><span>表格</span></a></li>
                    <li><a href="{:U('Crm/Reports/historys')}" class="j-ajax"><span>历史报表</span></a></li>
                </ul>
            </div>
        </div>
