...
<div class="bjui-pageContent">
    ...
    <div style="height:100%; overflow:hidden;">
      <fieldset style="height:100%;">
        <ul id="layout-tree" class="ztree" data-toggle="ztree" data-expand-all="true" data-on-click="do_open_layout">
          <li data-id="99999999" data-pid="0">票型分组</li>
          <volist name="data" id="vo">
            <li data-id="{$vo.id}" data-pid="99999999" data-url="{:U('Item/Product/type',array('menuid'=>pro_type_list,'gid'=>$vo['id']));}" data-divid="#pro_type_list">{$vo.name}</li>
          </volist>
        </ul>
      </fieldset>
    </div>
  ...
  <div style="margin-left:190px; height:99.9%; overflow:hidden;">
    <div id="pro_type_list" style="height:99.9%; overflow:hidden;"> </div>
  </div>
</div>