...
<form class="form-horizontal" action="{:U('Item/Product/groupEdit',array('menuid'=>$menuid));}" method="post" data-toggle="validate">
<div class="bjui-pageContent">
	 <div class="form-group">
    <label class="col-sm-2 control-label">分组名称:</label>
    <input type="text" name="name" class="form-control required" data-rule="required;" value="{$data.name}" size="40" placeholder="分组名称">
  </div>
  <div class="form-group">
