		...
		switch(type){
			...
			case '7':
				...
				$.each(data.remark,function(item,name){
					...
					LODOP.ADD_PRINT_TEXT(87,495,172,40,name);
					LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
			...
			case '12':
				...
				$.each(data.remark,function(item,name){
					...
					LODOP.ADD_PRINT_RECT(72,471,200,50,0,2);
					LODOP.ADD_PRINT_TEXT(99,475,196,23,"需同时持"+name+"市民身份证入场");
					LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
					LODOP.ADD_PRINT_TEXT(78,497,158,30,name+"市民优惠票");
					LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
					LODOP.SET_PRINT_STYLEA(0,"FontSize",14);
					LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				});
