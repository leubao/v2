...
<div class="bjui-pageContent">
  ...
  <div class="form-group" style="margin: 20px 0 20px; ">
      ...
      <input type="password" data-rule="新密码:required" name="password" value="" placeholder="新密码" size="20">
  </div>
  <div class="form-group">
      <label for="j_pwschange_secpassword" class="col-sm-2 control-label">确认密码：</label>
      <input type="password" data-rule="required;match(password)" name="new_pwdconfirm" value="" placeholder="确认新密码" size="20">
  </div>
  <div class="form-group">
