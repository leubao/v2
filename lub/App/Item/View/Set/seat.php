...
<div style="float:left; width:240px; " class="left_seat_info">
  ...
  <!--提交-->
  <div class="submit_seat"><a href="#" class="btn btn-success" onclick="post_server({$data.id},{$data.template_id},{$fid});">设置座位</a></div>
  <!--图列 s-->
  <div id="legend"></div>
  <!--left info e--> 
</div>
...
/*数据提交*/
function post_server(areaId,templateId,groupId){
  var postData = '',
      select_seat = $("#cart-seat-"+areaId).val();
