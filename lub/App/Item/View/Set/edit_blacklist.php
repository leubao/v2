...
<form class="form-horizontal" action="{:U('Item/Set/edit_blacklist',array('menuid'=>$menuid));}" method="post" data-toggle="validate">
<div class="bjui-pageContent">
  ...
  <div class="form-group">
    ...
    <input type="text" name="phone" class="form-control required" value="{$data.phone}" data-rule="required;" size="25" placeholder="电话">
  </div>
  <div class="form-group">
