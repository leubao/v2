...
<form id="pagerForm" data-toggle="ajaxsearch" action="{:U('Manage/Logs/error_log',array('menuid'=>$menuid));}" method="post">
 <!--Page --> 
...
<div class="bjui-pageContent tableContent">
  <table data-toggle="tablefixed" data-width="500" data-nowrap="true">
    <thead>
      <tr>
        <th width="80">ID</th>
