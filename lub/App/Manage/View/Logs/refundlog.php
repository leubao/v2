...
<!--条件检索 s-->
  <div class="bjui-searchBar">
    ...
    <select name="status" data-toggle="selectpicker">
        ...
        <option value="1" <if condition="$where['status'] eq '1'">selected</if>>申请成功</option>
        <option value="3" <if condition="$where['status'] eq '3'">selected</if>>退票成功</option>
        <option value="2" <if condition="$where['status'] eq '2'">selected</if>>退票驳回</option>
    </select>
