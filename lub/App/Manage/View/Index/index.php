      ...
      <div class="tabsPageHeader">
        <div class="tabsPageHeaderContent">
          <ul class="navtab-tab nav nav-tabs">
            <li data-url="{:U('Manage/Index/public_index_info');}"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
          </ul>
        </div>
...
var PRODUCT_CONF = {$PRODUCT_CONF}; 
/*消息提示*/
prompt();
toastr.options = {"closeButton": true,"debug": false,"progressBar": true,"positionClass": "toast-top-right", "onclick": null, "showDuration": "400","hideDuration": "1000","timeOut": "7000","extendedTimeOut": "50000","showEasing": "swing", "hideEasing": "linear","showMethod": "fadeIn", "hideMethod": "fadeOut"}
/*查询是否有短消息*/
