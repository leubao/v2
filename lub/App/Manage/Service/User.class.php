...
class User {
    ...
    private function registerLogin(array $userInfo) {
        ...
        //缓存所属公司及相关产品信息
        session(self::itemId,\Libs\Util\Encrypt::authcode((int) $userInfo['item_id'], ''));
        session(lub_proId,\Libs\Util\Encrypt::authcode((int) $userInfo['defaultpro'], '')); 
        //更新状态
